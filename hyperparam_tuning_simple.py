"""
Hyperparameter tuning script mirroring train_semi_ray.py
Uses Optuna instead of Ray Tune for simplicity
Finds best hyperparameters using a simple train/test split
"""
...
class Config:
    ...
    # Output
    OUTPUT_FILE = BASE_DIR / f'best_hyperparams_{DATASET}.json'
...
def objective(trial):
    """Optuna objective function - this gets called for each trial"""
    ...
    for epoch in range(Config.NUM_EPOCHS):
        ...
        f1_1 = val_scores['f1_per_class'][1]  # F1 for nuclei class
        ...
        if (epoch + 1) % 10 == 0:
            print(f"  Epoch {epoch+1}/{Config.NUM_EPOCHS}: "
                  ...
                  f"val_f1_1={f1_1:.4f}, best_f1_1={best_f1:.4f}")
...
def main():
    ...
    print("\nYou can now use these hyperparameters in train_5fold_cv.py")
